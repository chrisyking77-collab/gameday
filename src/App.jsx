...
const E={nfl:"https://site.api.espn.com/apis/site/v2/sports/football/nfl",cfb:"https://site.api.espn.com/apis/site/v2/sports/football/college-football",cbb:"https://site.api.espn.com/apis/site/v2/sports/basketball/mens-college-basketball",nba:"https://site.api.espn.com/apis/site/v2/sports/basketball/nba",mlb:"https://site.api.espn.com/apis/site/v2/sports/baseball/mlb",nhl:"https://site.api.espn.com/apis/site/v2/sports/hockey/nhl"};
...
const PC={QB:"#ef4444",RB:"#10b981",WR:"#3b82f6",TE:"#f59e0b",K:"#10b981",LB:"#f97316",CB:"#ec4899",S:"#10b981",DE:"#a855f7",DT:"#a855f7",PG:"#3b82f6",SG:"#ef4444",SF:"#10b981",PF:"#f59e0b",C:"#a855f7",G:"#3b82f6",F:"#10b981",SP:"#ef4444",RP:"#f97316","1B":"#10b981","2B":"#3b82f6","3B":"#f59e0b",SS:"#ec4899",LF:"#a855f7",CF:"#06b6d4",RF:"#10b981",DH:"#f97316",P:"#ef4444",LW:"#ef4444",RW:"#10b981",D:"#3b82f6",GK:"#f59e0b"};
...
function News(){
  ...
  const P={nfl:"football/nfl",nba:"basketball/nba",mlb:"baseball/mlb",nhl:"hockey/nhl",cfb:"football/college-football",cbb:"basketball/mens-college-basketball"};
  ...
  return<div><h2 style={{fontFamily:F,fontSize:18,fontWeight:800,color:S.tx,margin:"0 0 14px"}}>📰 News</h2>
    <div style={{display:"flex",gap:4,marginBottom:14}}>{[["nfl","🏈 NFL"],["nba","🏀 NBA"],["mlb","⚾ MLB"],["nhl","🏒 NHL"],["cfb","🏈 CFB"],["cbb","🏀 CBB"]].map(([k,l])=><Pill key={k} l={l} a={sport===k} c={S.ac} onClick={()=>setSport(k)}/>)}</div>
...
export default function App(){
  ...
  const sportIcons={NFL:"🏈",NBA:"🏀",MLB:"⚾",NHL:"🏒",CFB:"🏈",CBB:"🏀",FAN:"⚡",ODDS:"💰",MORE:"📰"};
  const sportColors={NFL:S.gn,NBA:S.pp,MLB:S.rd,NHL:S.tl,CFB:S.ac,CBB:S.or,FAN:"#14b8a6",ODDS:S.yl,MORE:S.pk};
  ...
  return<><style key={theme}>{`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap');@keyframes spin{to{transform:rotate(360deg)}}*{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent}body{background:${S.bg};color:${S.tx};overflow-x:hidden}::-webkit-scrollbar{width:4px;height:4px}::-webkit-scrollbar-track{background:${S.bg}}::-webkit-scrollbar-thumb{background:${S.bd};border-radius:3px}button{font-family:${F}}input{font-family:${F}}`}</style>
    ...
    {favs.length>0&&<div style={{background:S.sf,borderBottom:"1px solid "+S.bd,padding:"5px 10px",display:"flex",alignItems:"center",gap:5,overflowX:"auto"}}>
      ...
      {favs.map((f,i)=><button key={f.abbr+f.sport+i} onClick={()=>{
        const sm={nfl:"NFL",nba:"NBA",mlb:"MLB",nhl:"NHL",cfb:"CFB",cbb:"CBB"};const st={nfl:"sc",nba:"nbsc",mlb:"mlsc",nhl:"hlsc",cfb:"csc",cbb:"bsc"};
